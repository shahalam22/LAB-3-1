...
if __name__ == "__main__":
    ...
    # # Build a tree and print its structure (Entropy)
    ...
    # Build a tree and print its structure (Misclassification Error)
    print("Decision Tree Structure (Misclassification Error):\n")
    decision_tree = build_tree(X_train.tolist(), y_train.tolist(), calculate_misclassification_error, max_depth=3)
    print_tree(decision_tree)
